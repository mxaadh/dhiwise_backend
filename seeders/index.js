...
async function seedUser () {
  try {
    ...
    userToBeInserted = {
      'password':'Ob6VqBGaKtpeIBB',
      'isDeleted':false,
      'username':'Hardy_Schuppe73',
      'email':'Corbin.Sawayn@gmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.User
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let user = await dbService.updateOne(User, { 'username':'Hardy_Schuppe73' }, userToBeInserted,  { upsert: true });
    userToBeInserted = {
      'password':'6s0Z6dVKLrm5qw0',
      'isDeleted':false,
      'username':'Annabell_Kunze',
      'email':'Vladimir_Renner95@yahoo.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.Admin
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let admin = await dbService.updateOne(User, { 'username':'Annabell_Kunze' }, userToBeInserted,  { upsert: true });
